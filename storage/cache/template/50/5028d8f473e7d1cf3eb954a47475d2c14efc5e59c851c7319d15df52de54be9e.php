...
class __TwigTemplate_638a0f7c03de185b37dfbd8d2090d2cea9efd4cee68ca501d9f43ba41b7466d1 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <form action=\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["return_reason"]) {
            // line 104
            echo "              ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["return_reason"], "return_reason_id", [], "any", false, false, false, 104), ($context["return_reason_id"] ?? null)))) {
                // line 105
