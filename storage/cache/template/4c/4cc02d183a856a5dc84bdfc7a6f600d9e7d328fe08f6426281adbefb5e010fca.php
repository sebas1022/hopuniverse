...
class __TwigTemplate_f4283adc70ce990a892b65e4ffd6f465401be3a32a82d20227d66f15b4aa82bf extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["directory"]) {
            // line 35
            echo "                  ";
            if ((0 === twig_compare($context["directory"], ($context["theme_default_directory"] ?? null)))) {
                // line 36
                echo "                  <option value=\"";
