...
class __TwigTemplate_38a2b67c5c5b39e8b55464a52eccd472dc785876183d91b27305ec103d58d354 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <form action=\"";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["voucher_theme"]) {
            // line 63
            echo "            ";
            if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["voucher_theme"], "voucher_theme_id", [], "any", false, false, false, 63), ($context["voucher_theme_id"] ?? null)))) {
                // line 64
