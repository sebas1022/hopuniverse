...
class ModelOcslideshowSlide extends Model {
	...
	public function getocslideshowImages($ocslideshow_id) {
		...
		$ocslideshow_image_query = $this->db->query("SELECT * FROM " . DB_PREFIX . "ocslideshow_image WHERE ocslideshow_id = '" . (int)$ocslideshow_id . "' ORDER BY order_image ASC");
		...
		foreach ($ocslideshow_image_query->rows as $ocslideshow_image) {
			...
			$ocslideshow_image_data[] = array(
				...
				'order_image'              => $ocslideshow_image['order_image'],
