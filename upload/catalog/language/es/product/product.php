...
$_['text_login']               = 'Por favor <a href="%s">inicia sesión</a> o <a href="%s">regístrate</a> para reseñar';
$_['text_no_reviews']          = 'No hay reseñas para este producto.';
$_['text_note']                = '<span class="text-danger">Nota:</span> ¡HTML no se traduce!';
$_['text_success']             = 'Gracias por tu reseña. Ha sido enviada al administrador web para su aprobación.';
