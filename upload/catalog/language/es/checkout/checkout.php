...
$_['text_register_account']          = 'Al crear una cuenta podrás comprar más rápido, estar al día con el estado de tus pedidos y hacer seguimiento de los pedidos que hayas realizado anteriormente.';
...
$_['text_payment_method']            = 'Por favor selecciona el método de pago preferido para usar en este pedido.';
...
$_['text_trial_description']         = '%s cada %d %s(s) por %d pago(s) luego';
...
$_['entry_newsletter']               = 'Deseo suscribirme al boletín %s.';
$_['entry_shipping']                 = 'Mis direcciones de entrega y facturación son las mismas.';

// Error
$_['error_warning']                  = '¡Hubo un problema al intentar procesar tu pedido! Si el problema persiste, por favor intenta seleccionar un método de pago diferente o puedes contactar al propietario de la tienda <a href="%s">haciendo clic aquí</a>.';
$_['error_login']                    = 'Advertencia: No hay coincidencia para la dirección de E-Mail y/o Contraseña.';
...
$_['error_approved']                 = 'Advertencia: Tu cuenta requiere aprobación antes de poder iniciar sesión.';
...
$_['error_agree']                    = 'Advertencia: ¡Debes estar de acuerdo con %s!';
$_['error_address']                  = 'Advertencia: ¡Debes seleccionar una dirección!';
$_['error_shipping']                 = 'Advertencia: ¡Método de envío requerido!';
$_['error_no_shipping']              = 'Advertencia: No hay opciones de envío disponibles. Por favor <a href="%s">contáctanos</a> para obtener ayuda!';
