...
$_['text_success']						 = 'Correcto: Ha modificadp Klarna Checkout!';
$_['text_edit']							 = 'Editar Klarna Checkout';
$_['text_live']							 = 'En vivo';
$_['text_test']							 = 'Test';
$_['text_payment_info']					 = 'Informacion Pago';
$_['text_na']							 = 'N/A';
$_['text_confirm_cancel']				 = 'Seguro que quieres cancelar esta transaccion?';
$_['text_confirm_capture']				 = 'Esta seguro de que quiere capturar';
...
$_['button_account_add']				 = 'Nueva cuenta';
$_['button_capture']					 = 'Captura';
$_['button_refund']						 = 'Reembolso';
$_['button_extend_authorization']		 = 'Ampliar';
$_['button_release_authorization']		 = 'Lanzamiento';
$_['button_update']						 = 'Actualizar';
$_['button_add_shipping_info']			 = 'Adicionar informacion de envio';
$_['button_trigger_send_out']			 = 'Activar nuevo envio';
$_['button_edit_shipping_info']			 = 'Editar información de envio';
$_['button_edit_billing_address']		 = 'Editar dirección de facturacion';
$_['button_new_capture']				 = 'Nueva captura';
$_['button_new_refund']					 = 'Nuevo reembolso';
$_['button_process_settlement']			 = 'Procesar archivos de liquidacion';

// Error
$_['error_warning']						 = 'Importante: Por favor revise el formulario cuidadosamente para resolver los errores.';
$_['error_php_version']					 = 'Version minima de PHP 5.4.0 requerida.';
$_['error_ssl']							 = 'Debe usar SSL y tener un certificado SSL instalado.';
$_['error_account_minimum']				 = 'Por favor agregue al menos una cuenta.';
$_['error_locale']						 = 'Por favor, introduzca una configuracion regional valida.';
$_['error_account_currency']			 = 'La lista de cuentas contiene una o mas monedas duplicadas.';
$_['error_merchant_id']					 = 'ID Comercio requerido.';
$_['error_secret']						 = 'Shared Secret requerido.';
$_['error_tax_warning']					 = 'Importante: Some of your products use a Payment Address based Tax Class. Klarna Checkout will not work when any of these are placed in the cart.';

// Tab
$_['tab_setting']						 = 'Configuracion';
$_['tab_order_status']					 = 'Estado del pedido';
$_['tab_account']						 = 'Cuentas';
$_['tab_settlement']					 = 'Asentamiento';