...
$_['text_success']          = 'Correcto: Ha modificado United States Postal Service!';
...
// Help
$_['help_dimension']        = 'Dimensiones del paquete promedio para el paquete de envio. Las dimensiones del producto no se utilizan para el envio en este momento.';
$_['help_display_time']     = 'Quieres visualizar el tiempo de envío? (ej. Barco entre 3 y 5 dias)';
$_['help_display_weight']   = 'Quieres mostrar el peso del envio? (ej. Peso de entrega: 2.7674 kg)';
$_['help_weight_class']     = 'Debe establecerse en libras.';
$_['help_debug']      		= 'Guarda datos de envio / recepcion en el registro del sistema';

// Error
$_['error_permission']      = 'Advertencia: No dispone de permiso para modificar United States Postal Service.';
