...
class ControllerDesignTranslation extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			// Redirigir a la traducción recién creada
			$this->response->redirect($this->url->link('design/translation/edit', 'user_token=' . $this->session->data['user_token'] . '&translation_id=' . $translation_id, true));
		}
	...
	protected function getList() {
		...
		$pagination->url = $this->url->link('design/translation', 'user_token=' . $this->session->data['user_token'] . $url . '&page={page}', true);
